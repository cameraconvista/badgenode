...
describe('storico.service', () => {
  ...
  describe('buildStoricoDataset (mock test)', () => {
    it('should include days without timbrature with 0.00 hours', () => {
      ...
      const mockTotali = [
        { giorno_logico: '2025-10-08', ore_totali_chiuse: 4.0, sessioni_chiuse: 1, sessioni_totali: 1 },
        { giorno_logico: '2025-10-10', ore_totali_chiuse: 8.48, sessioni_chiuse: 1, sessioni_totali: 1 }
      ];
      
      const mockSessioni = [
        { giorno_logico: '2025-10-08', entrata_id: 1, entrata_ore: '09:00:00', uscita_id: 2, uscita_ore: '13:00:00', ore_sessione: 4.0, sessione_num: 1 },
        { giorno_logico: '2025-10-10', entrata_id: 3, entrata_ore: '22:00:00', uscita_id: 4, uscita_ore: '06:29:00', ore_sessione: 8.48, sessione_num: 1 }
      ];
      ...
      const daysWith000 = expectedDays.filter(day => 
        !mockTotali.some(t => t.giorno_logico === day)
      );
