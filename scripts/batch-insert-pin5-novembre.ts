...
/**
 * Script per inserimento timbrature novembre 2025 - PIN 5
...
// Dati timbrature novembre 2025 da inserire per PIN 5
const timbrature = [
  // 16 Giov, 17:00 → 01:30 (+1)
  { date: '2025-11-16', time: '17:00', tipo: 'entrata' },
  { date: '2025-11-17', time: '01:30', tipo: 'uscita' },
  
  // 17 Vene, 17:15 → 02:14 (+1)
  { date: '2025-11-17', time: '17:15', tipo: 'entrata' },
  { date: '2025-11-18', time: '02:14', tipo: 'uscita' },
  
  // 18 Saba, 17:03 → 02:28 (+1)
  { date: '2025-11-18', time: '17:03', tipo: 'entrata' },
  { date: '2025-11-19', time: '02:28', tipo: 'uscita' },
  
  // 23 Giov, 17:02 → 02:10 (+1)
  { date: '2025-11-23', time: '17:02', tipo: 'entrata' },
  { date: '2025-11-24', time: '02:10', tipo: 'uscita' },
  
  // 24 Vene, 16:58 → 03:04 (+1)
  { date: '2025-11-24', time: '16:58', tipo: 'entrata' },
  { date: '2025-11-25', time: '03:04', tipo: 'uscita' },
  
  // 25 Saba, 17:03 → 02:02 (+1)
  { date: '2025-11-25', time: '17:03', tipo: 'entrata' },
  { date: '2025-11-26', time: '02:02', tipo: 'uscita' },
  
  // 26 Dome, 17:09 → 00:49 (+1)
  { date: '2025-11-26', time: '17:09', tipo: 'entrata' },
  { date: '2025-11-27', time: '00:49', tipo: 'uscita' },
  
  // 27 Lune, 17:06 → 01:10 (+1)
  { date: '2025-11-27', time: '17:06', tipo: 'entrata' },
  { date: '2025-11-28', time: '01:10', tipo: 'uscita' }
];
...
async function main() {
  ...
  console.log('');
  console.log('📈 RIEPILOGO INSERIMENTO NOVEMBRE 2025 - PIN 5:');
  console.log(`✅ Successi: ${successCount}`);
  console.log(`❌ Errori: ${errorCount}`);
  console.log(`📊 Totale: ${successCount + errorCount}`);
  
  if (errorCount === 0) {
    console.log('🎉 INSERIMENTO PIN 5 COMPLETATO CON SUCCESSO!');
    console.log('');
    console.log('📋 PATTERN TURNI PIN 5 NOVEMBRE:');
    console.log('- 8 turni notturni consecutivi (16-18, 23-27 novembre)');
